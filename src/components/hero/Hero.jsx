  ...
  return (
    <div className="hero-container">
      ...
      >
        <SwiperSlide
          data-hash="slide1"
          className="view-slide view-slide-1"
          // style={{
        ...
        <SwiperSlide data-hash="slide2" className="view-slide view-slide-2">
          <div className="slide-content">
            <div className="hero-overlay"></div>
        ...
        <SwiperSlide data-hash="slide3" className="view-slide view-slide-3">
          <div className="slide-content">
            <div className="hero-overlay"></div>
